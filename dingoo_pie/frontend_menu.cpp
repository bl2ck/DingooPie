...
enum FrontendMenuCommand
{
    ...
    MENU_VIDEO_FILTER_NEAREST,
    MENU_VIDEO_FILTER_LINEAR,
    MENU_VIDEO_EFFECT_NORMAL,
    MENU_VIDEO_EFFECT_GRAYSCALE,
    MENU_VIDEO_EFFECT_INVERT,
    MENU_VIDEO_EFFECT_INVERT_GRAYSCALE,
    MENU_VIDEO_EFFECT_SEPIA,
    MENU_VIDEO_EFFECT_AMBER,
    ...
    MENU_SETTINGS_CPU_CLOCK_240,
    MENU_SETTINGS_CPU_CLOCK_288,
    MENU_SETTINGS_CPU_CLOCK_336,
    MENU_SETTINGS_CPU_CLOCK_408,
...
void frontendMenuAttach(void* nativeWindow, EmulatorSettings* settings, const std::string& currentAppPath)
{
    ...
    appendMenuItem(filterMenu, MENU_VIDEO_FILTER_NEAREST, uiText(TXT_VIDEO_FILTER_NEAREST));
    appendMenuItem(filterMenu, MENU_VIDEO_FILTER_LINEAR, uiText(TXT_VIDEO_FILTER_LINEAR));
    AppendMenuW(videoMenu, MF_POPUP, (UINT_PTR)filterMenu, uiText(TXT_VIDEO_FILTER));
    ...
    appendMenuItem(effectMenu, MENU_VIDEO_EFFECT_INVERT_GRAYSCALE, uiText(TXT_VIDEO_EFFECT_INVERT_GRAYSCALE));
    appendMenuItem(effectMenu, MENU_VIDEO_EFFECT_SEPIA, uiText(TXT_VIDEO_EFFECT_SEPIA));
    appendMenuItem(effectMenu, MENU_VIDEO_EFFECT_AMBER, uiText(TXT_VIDEO_EFFECT_AMBER));
    ...
    appendMenuItem(cpuClockMenu, MENU_SETTINGS_CPU_CLOCK_240, L"240 MHz");
    appendMenuItem(cpuClockMenu, MENU_SETTINGS_CPU_CLOCK_288, L"288 MHz");
    appendMenuItem(cpuClockMenu, MENU_SETTINGS_CPU_CLOCK_336, L"336 MHz");
    appendMenuItem(cpuClockMenu, MENU_SETTINGS_CPU_CLOCK_408, L"408 MHz");
    ...
    appendMenuItem(settingsMenu, MENU_SETTINGS_SAVE, uiText(TXT_SETTINGS_SAVE));
...
void frontendMenuRefresh(void)
{
...
#ifdef _WIN32
    setMenuEnabled(MENU_FILE_RESTART, !g_currentAppPath.empty());
    ...
    setMenuCheck(MENU_VIDEO_FILTER_NEAREST, g_menuSettings->videoFilter == VIDEO_FILTER_NEAREST);
    setMenuCheck(MENU_VIDEO_FILTER_LINEAR, g_menuSettings->videoFilter == VIDEO_FILTER_LINEAR);
    ...
    setMenuCheck(MENU_VIDEO_EFFECT_INVERT_GRAYSCALE, g_menuSettings->colorEffect == COLOR_EFFECT_INVERT_GRAYSCALE);
    setMenuCheck(MENU_VIDEO_EFFECT_SEPIA, g_menuSettings->colorEffect == COLOR_EFFECT_SEPIA);
    setMenuCheck(MENU_VIDEO_EFFECT_AMBER, g_menuSettings->colorEffect == COLOR_EFFECT_AMBER);
    ...
    setMenuCheck(MENU_SETTINGS_CPU_CLOCK_240, g_menuSettings->cpuClockHz == "240000000");
    setMenuCheck(MENU_SETTINGS_CPU_CLOCK_288, g_menuSettings->cpuClockHz == "288000000");
    setMenuCheck(MENU_SETTINGS_CPU_CLOCK_336, g_menuSettings->cpuClockHz == "336000000");
    setMenuCheck(MENU_SETTINGS_CPU_CLOCK_408, g_menuSettings->cpuClockHz == "408000000");
...
bool frontendMenuHandleCommand(unsigned int commandId)
{
    ...
    case MENU_VIDEO_FULLSCREEN:
        ...
        frontendMenuRefresh();
        return true;
    case MENU_VIDEO_FILTER_NEAREST:
        g_menuSettings->videoFilter = VIDEO_FILTER_NEAREST;
        frontendApplyVideoSettings(*g_menuSettings);
        emulatorSaveSettings(*g_menuSettings);
        frontendMenuRefresh();
        return true;
    case MENU_VIDEO_FILTER_LINEAR:
        g_menuSettings->videoFilter = VIDEO_FILTER_LINEAR;
        frontendApplyVideoSettings(*g_menuSettings);
        emulatorSaveSettings(*g_menuSettings);
        frontendMenuRefresh();
        return true;
    ...
    case MENU_VIDEO_EFFECT_INVERT:
        ...
        frontendMenuRefresh();
        return true;
    case MENU_VIDEO_EFFECT_INVERT_GRAYSCALE:
        g_menuSettings->colorEffect = COLOR_EFFECT_INVERT_GRAYSCALE;
        frontendApplyVideoSettings(*g_menuSettings);
        emulatorSaveSettings(*g_menuSettings);
        frontendMenuRefresh();
        return true;
    case MENU_VIDEO_EFFECT_SEPIA:
        ...
        frontendMenuRefresh();
        return true;
    case MENU_VIDEO_EFFECT_AMBER:
        g_menuSettings->colorEffect = COLOR_EFFECT_AMBER;
        frontendApplyVideoSettings(*g_menuSettings);
        emulatorSaveSettings(*g_menuSettings);
        frontendMenuRefresh();
        return true;
    ...
    case MENU_SETTINGS_CPU_CLOCK_240:
    case MENU_SETTINGS_CPU_CLOCK_288:
    case MENU_SETTINGS_CPU_CLOCK_336:
    case MENU_SETTINGS_CPU_CLOCK_408:
        ...
        else if (commandId == MENU_SETTINGS_CPU_CLOCK_240)
        {
            g_menuSettings->cpuClockHz = "240000000";
        }
        else if (commandId == MENU_SETTINGS_CPU_CLOCK_288)
        {
            g_menuSettings->cpuClockHz = "288000000";
        }
        ...
        {
            g_menuSettings->cpuClockHz = "408000000";
        }
