...
$required = @(
    ...
    'native\core\app\hle\app_text_format.cpp',
    'native\core\shared\services\guest_audio.cpp',
    'native\core\shared\services\audio_output.h',
    'native\core\frontend\audio\audio_validation_capture.cpp',
    'native\core\frontend\audio\audio_validation_capture.h',
    'native\core\app\cpu\mips_compat.cpp',
    'native\core\app\runtime\app_runtime_debug.cpp',
    ...
    'native\core\app\cpu\ppsspp_bridge.cpp',
    'cheats\README.md',
